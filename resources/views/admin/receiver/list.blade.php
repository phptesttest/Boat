        ...
        <div class="panel">
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <table class="table">
                    <tr>
                        <td>获得祝福时间</td>
                        <td><input type="radio" name='time' checked="checked" value="1">全部时间</td>
                        <td><input type="radio" name="time" value="2016-07-25">2016-07-25</td>
                        <td><input type="radio" name="time" value="2016-07-26">2016-07-26</td>
                        <td><input type="radio" name="time" value="2016-07-27">2016-07-27</td>
                    </tr>
                    <tr>
                        <td>祝福的类型</td>

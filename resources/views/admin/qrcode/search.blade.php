    ...
    <div class="col-xs-12 col-sm-12">
        <div class="panel">
            ...
            @if (count($errors) > 0)
                ...
                @endif
            <table class="table">
                    <form method="post" action="{{ asset('admin/qrcode/search')}}" enctype="multipart/form-data" onsubmit="return check();">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <tr class="form-group">
                            <td class='control-label' >渠道编码：</td>
                            <td><input id="name" type="text" name="coding" /></td>
                        </tr>
                        <tr class="form-group">
                            <td colspan="2"><input type="submit" value="筛选" class="btn btn-info" /></td>
                        </tr>
                    </form>
                </table>
            </div>
